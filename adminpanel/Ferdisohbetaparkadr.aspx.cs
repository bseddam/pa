...
public partial class adminpanel_Ferdisohbetaparkadr : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            LinkButton tb = cp.FindControl("Ferdisohbetaparkadr") as LinkButton;
            tb.BackColor = Color.Brown;
        }
    }
    void meqsedyeri()
    {
        DataTable meqsed = klas.getdatatable("Select ClassifID,ClassifName,ListID from List_classifications where ListID=17 order by sort");
    ...
    void ihbsort()
    {
        ...
        ddlmovqe.DataTextField = "ClassifName";
    ...
    void ihbredakte()
    {
        DataTable dtilceler = klas.getdatatable("Select * from List_classifications Where ListID=" + ddlihbrayonredakte.SelectedValue + " order by [sort]");
        ddlihbredakte.DataTextField = "ClassifName";
    ...
    void ihbredakte1()
    {
        DataTable dtilceler = klas.getdatatable("Select * from List_classifications Where ListID=" + ddlicra.SelectedValue + " order by [sort]");
        ddlvezife.DataTextField = "ClassifName";
    ...
    {
        DataTable dtilceler = klas.getdatatable("Select * from List_classifications Where ListID=" + ddlicra.SelectedValue + " order by [sort]");
        ddlyer.DataTextField = "ClassifName";
    ...
    void ihbsil()
    {
        DataTable dtilceler = klas.getdatatable("Select * from List_classifications Where ListID=" + ddlihbraysil.SelectedValue + " order by sort");
        ddlihbsil.DataTextField = "ClassifName";
    ...
    {
        DataRow drrayon = klas.GetDataRow("Select * from List_classifications Where ListID=17 and ClassifName=N'" + txtmeqsedredakte.Text + "'");

        if (ddlmeqsedredakte.SelectedValue != "0" && txtmeqsedredakte.Text != "" && drrayon == null)
        {
            SqlConnection baglanti = klas.baglan();
            SqlCommand cmd = new SqlCommand("Update List_classifications Set ClassifName=@ClassifName Where ListID=17 and ClassifID=" + ddlmeqsedredakte.SelectedValue, baglanti);
            ...
            ddlmeqsedredakte.Items.Insert(0, new ListItem("Seçin", "0"));
            txtmeqsedredakte.Text = "";
            Response.Redirect("Ferdisohbetaparkadr.aspx");
        }
        else
        {
            if (ddlmeqsedredakte.SelectedValue == "0")
            {
                lblmeqsedredakte.Text = "İcra orqanını seçməmisiniz";
            }
            if (txtmeqsedredakte.Text == "")
            {
                lblmeqsedredakte.Text = "İcra orqanı boşluq ola bilməz";
            }
            if (drrayon != null)
            {
    ...
    protected void btnmeqsedelave_Click(object sender, EventArgs e)
    {
        ...
        {
            DataRow drrayon = klas.GetDataRow("Select * from List_classifications Where ListID=17 and ClassifName=N'" + txtmeqsedelave.Text + "'");
            if (drrayon == null && ddlmeqsedsort.SelectedValue != "-1")
            {
                ...
                cmd.ExecuteNonQuery();
                lblmeqsedelave.Text = "İcra orqanı əlavə edildi";
        ...
        {
            lblmeqsedelave.Text = "İcra orqanı boşluq ola bilməz";
            lblmeqsedelave.ForeColor = Color.Red;
        }
    }
    protected void btnmeqsedsil_Click(object sender, EventArgs e)
    {
        if (ddlmeqsedsil.SelectedValue != "0")
        {
            DataRow classifid;
            string classifid1;
            classifid = klas.GetDataRow("Select * from List_classifications Where ListID=17 and ClassifID='" + ddlmeqsedsil.SelectedValue + "'");
            classifid1 = classifid["sort"].ToString();
            int secilmiwsortid = int.Parse(classifid1.ToString());
            ...
            klas.cmd("Delete from List_classifications  Where ListID=17 and ClassifID=" + ddlmeqsedsil.SelectedValue);
            lblmeqsedsil.Text = "İcra orqanı silindi";
            lblmeqsedsil.ForeColor = Color.Green;
            Response.Redirect("Ferdisohbetaparkadr.aspx");
        }
        else
        {
            lblmeqsedsil.Text = "İcra orqanı seçilməyib";
    ...
    protected void btnihbelave_Click(object sender, EventArgs e)
    {
        ...
        {
            DataRow drrayon = klas.GetDataRow("Select * from List_classifications Where ListID='" + ddlihbrayonelave.SelectedValue + "' and  ClassifName=N'" + txtihbelave.Text + "' order by [ClassifName]");
            if (drrayon == null && ddlmovqe.SelectedValue != "-1")
            {
                if (ddlmovqe.SelectedValue != "0")
                {
                    classifid = klas.GetDataRow("Select * from List_classifications Where ListID='" + ddlihbrayonelave.SelectedValue + "' and ClassifID='" + ddlmovqe.SelectedValue + "'");
                    classifid1 = classifid["sort"].ToString();
                }
                else
                {
                ...
                SqlConnection baglanti1 = klas.baglan();
                SqlCommand cmd = new SqlCommand("Insert into List_classifications (ClassifName,ListID,sort) values(@ClassifName,@ListID,@sort)", baglanti1);
                cmd.Parameters.Add("ClassifName", txtihbelave.Text);
                cmd.Parameters.Add("ListID", int.Parse(ddlihbrayonelave.SelectedValue));
                cmd.Parameters.Add("sort", int.Parse(classifid1.ToString()) + 1);
                cmd.ExecuteNonQuery();
                lblihbelave.Text = "Məqsəd əlavə edildi";
        ...
        {
            lblihbelave.Text = "Tutduğu vəzifə boşluq ola bilməz";
            lblihbelave.ForeColor = Color.Red;
        }
        ...
        //if (txtihbelave.Text != "" && ddlihbrayonelave.SelectedValue != "0")
        //{
        //    DataRow drrayon1 = klas.GetDataRow("Select * from List_classifications Where ListID='" + ddlihbrayonelave.SelectedValue + "' and  ClassifName='" + txtihbelave.Text + "' order by [ClassifName]");
        //    if (drrayon1 == null)
        //    {
        //        SqlConnection baglanti = klas.baglan();
        //        SqlCommand cmd = new SqlCommand("Insert into List_classifications (ClassifName,ListID) values(@ClassifName,@ListID)", baglanti);
        //        cmd.Parameters.Add("ClassifName", txtihbelave.Text);
        //        cmd.Parameters.Add("ListID", ddlihbrayonelave.SelectedValue);
        //        cmd.ExecuteNonQuery();
        //        lblihbelave.Text = "Tutduğu vəzifə ?lav? edildi";
        //        lblihbelave.ForeColor = Color.Aquamarine;
        //    }
        //    else
        //    {
        //        lblihbelave.Text = "Elavə etmək istədiyiniz artıq bazada var";
        //        lblihbelave.ForeColor = Color.GreenYellow;

        //    }
        //}
        //else
        //{
        //    lblihbelave.Text = "Tutduğu vəzifə ad? boşluq ola bilməz";
        //    lblihbelave.ForeColor = Color.GreenYellow;
        //    if (ddlihbrayonelave.SelectedValue == "0")
        //    {
        //        lblihbelave.Text = "Tutduğu vəzifəni Seçin";
        //        lblihbelave.ForeColor = Color.GreenYellow;
        //    }
        //}
    }
    ...
    {
        DataRow drrayon = klas.GetDataRow("Select * from List_classifications Where ClassifID='" + ddlihbredakte.SelectedValue + "' and ClassifName=N'" + txtihbredakte.Text + "'");

        if (ddlihbredakte.SelectedValue != "0" && txtihbredakte.Text != "" && drrayon == null)
        {
            SqlConnection baglanti = klas.baglan();
            SqlCommand cmd = new SqlCommand("Update List_classifications Set ClassifName=@ClassifName Where ClassifID=" + ddlihbredakte.SelectedValue, baglanti);
            cmd.Parameters.Add("ClassifName", txtihbredakte.Text);
            cmd.ExecuteNonQuery();
        ...
        else
        {
            ...
            {
                lblihbredakte.Text = "Tutduğu vəzifə seçməmisiniz";
            }
            if (txtihbredakte.Text == "")
            {
                lblihbredakte.Text = "Tutduğu vəzifə adı boşluq ola bilməz";
            }
            if (drrayon != null)
            {
    ...
    protected void btnihbsil_Click(object sender, EventArgs e)
    {
        if (ddlihbsil.SelectedValue != "0" && ddlihbraysil.SelectedValue != "0")
        {
            DataRow classifid;
            string classifid1;
            classifid = klas.GetDataRow("Select * from List_classifications Where ListID='" + ddlihbraysil.SelectedValue + "' and ClassifID='" + ddlihbsil.SelectedValue + "'");
            classifid1 = classifid["sort"].ToString();
            int secilmiwsortid = int.Parse(classifid1.ToString());

            DataTable sorthamisi = klas.getdatatable("Select * from List_classifications Where ListID=" + ddlihbraysil.SelectedValue);
            for (int i = 0; i < sorthamisi.Rows.Count; i++)
            {
                if (secilmiwsortid < int.Parse(sorthamisi.Rows[i]["sort"].ToString()))
                {
                    ...
                    int classif = int.Parse(sorthamisi.Rows[i]["ClassifID"].ToString());
                    SqlConnection baglanti = klas.baglan();
                    SqlCommand cmd1 = new SqlCommand("Update List_classifications Set sort=@sort Where ListID='" + ddlihbraysil.SelectedValue + "' and sort='" + a.ToString() + "' and ClassifID='" + classif.ToString() + "'", baglanti);
                    cmd1.Parameters.Add("sort", a1);
                    cmd1.ExecuteNonQuery();
                }
            ...
            btnmeqsedsil.Enabled = false;
            klas.cmd("Delete from List_classifications  Where ClassifID=" + ddlihbsil.SelectedValue);
    ...
    protected void btniedsil_Click(object sender, EventArgs e)
    {
        ...
        //    btnihbsil.Enabled = false;
        //    klas.cmd("Delete from List_classifications Where ClassifID=" + ddlihbsil.SelectedValue);
        //    lblihbsil.Text = "Tutduğu vəzifə silindi";
        //    lblihbsil.ForeColor = Color.Aquamarine;
        //}
        //else
        //{
        //    lblihbsil.Text = "Tutduğu vəzifə seçilməyib";
    ...
    protected void btnyerinideyiw_Click(object sender, EventArgs e)
    {
        ...
        {
            obyekt = klas.GetDataRow("Select * from List_classifications Where ListID=17 and ClassifID='" + ddlobject.SelectedValue + "'");
            obyekt1 = obyekt["sort"].ToString();
            int objekt = int.Parse(obyekt1.ToString());
            //Response.Write(obyekt1);
            if (ddlyeri.SelectedValue != "0")
            {
                classifid = klas.GetDataRow("Select * from List_classifications Where ListID=17 and ClassifID='" + ddlyeri.SelectedValue + "'");
                classifid1 = classifid["sort"].ToString();
            }
            else
            {
            ...
            for (int i = 0; i < sorthamisi.Rows.Count; i++)
            {
                ...
                if ((secilmiwsortid >= int.Parse(sorthamisi.Rows[i]["sort"].ToString())) && (objekt < int.Parse(sorthamisi.Rows[i]["sort"].ToString())))
                {
                    ...
                    SqlConnection baglanti1 = klas.baglan();
                    SqlCommand cmd12 = new SqlCommand("Update List_classifications Set sort=@sort Where ListID=17 and sort='" + objekt.ToString() + "' and ClassifID='" + ddlobject.SelectedValue + "'", baglanti1);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            obyekt = klas.GetDataRow("Select * from List_classifications Where ListID=" + ddlicra.SelectedValue + " and ClassifID='" + ddlvezife.SelectedValue + "'");
            obyekt1 = obyekt["sort"].ToString();
            int objekt = int.Parse(obyekt1.ToString());
            //Response.Write(obyekt1);
            if (ddlyer.SelectedValue != "0")
            {
                classifid = klas.GetDataRow("Select * from List_classifications Where ListID=" + ddlicra.SelectedValue + " and ClassifID='" + ddlyer.SelectedValue + "'");
                classifid1 = classifid["sort"].ToString();
            }
            else
            {
                classifid = klas.GetDataRow("Select MIN(sort) as sort from List_classifications Where ListID=" + ddlicra.SelectedValue + "");
                //int.Parse(classifid.ToString()) - 1;
                classifid1 = (int.Parse(classifid["sort"].ToString()) - 1).ToString();
            }
            //Response.Write(classifid1);
            int secilmiwsortid = int.Parse(classifid1.ToString());
            DataTable sorthamisi = klas.getdatatable("Select * from List_classifications Where ListID=" + ddlicra.SelectedValue + "");
            for (int i = 0; i < sorthamisi.Rows.Count; i++)
            {
                ...
                if ((secilmiwsortid >= int.Parse(sorthamisi.Rows[i]["sort"].ToString())) && (objekt < int.Parse(sorthamisi.Rows[i]["sort"].ToString())))
                {
                    ...
                    int classif = int.Parse(sorthamisi.Rows[i]["ClassifID"].ToString());
                    SqlConnection baglanti = klas.baglan();
                    SqlCommand cmd1 = new SqlCommand("Update List_classifications Set sort=@sort Where ListID=" + ddlicra.SelectedValue + " and sort='" + a.ToString() + "' and ClassifID='" + classif.ToString() + "'", baglanti);
                    cmd1.Parameters.Add("sort", a1);
                    cmd1.ExecuteNonQuery();
                    //Response.Write("obyekt="+objekt.ToString());
                    //Response.Write("yer=" + classifid1.ToString());
                    SqlConnection baglanti1 = klas.baglan();
                    SqlCommand cmd12 = new SqlCommand("Update List_classifications Set sort=@sort Where ListID=" + ddlicra.SelectedValue + " and sort='" + objekt.ToString() + "' and ClassifID='" + ddlvezife.SelectedValue + "'", baglanti1);
                    cmd12.Parameters.Add("sort", classifid1);
                    cmd12.ExecuteNonQuery();
