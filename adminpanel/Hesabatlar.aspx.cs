...
public partial class Vizuallawma : System.Web.UI.Page
{
...
FROM         dbo.Users INNER JOIN  dbo.business_trip ON dbo.Users.UserID = dbo.business_trip.UserID where 1=1  "
            + asort + " ORDER BY   dbo.Users.Name,dbo.Users.SName, dbo.business_trip.RegionCome DESC";
    ...
    void dlyenideniwle()
    {
        ...
        string s = @"SELECT     dbo.Users.Name + ' ' + dbo.Users.Sname AS username, dbo.Users.UserID, dbo.business_trip.RegionCome, dbo.business_trip.GoFromRegion,  
dbo.business_trip.FileName,dbo.business_trip.ComingToWork, dbo.business_trip.Regions, dbo.business_trip.RegionID, dbo.business_trip.BusinessTripID
FROM dbo.Users INNER JOIN dbo.business_trip ON dbo.Users.UserID = dbo.business_trip.UserID  where AssortinID=3 ORDER BY
dbo.Users.Name,dbo.Users.SName, dbo.business_trip.RegionCome DESC";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string s = "";
        string ltext="";
        if (ddlusers.SelectedValue != "-1" && ddlryn.SelectedValue != "-1" && ddlryn.SelectedValue != "0")
        {
            ltext = @" and  (dbo.Users.UserID = '" + ddlusers.SelectedValue + "')  and dbo.business_trip.RegionID= '" + ddlryn.SelectedValue + "' AND (dbo.business_trip.RegionCome >= '" + lblgelme1.Text + "' ) AND (dbo.business_trip.GoFromRegion <= '" + lblgetme1.Text + "') ";
            //Response.Write("1"); 
        }
        else if (ddlryn.SelectedValue == "-1" && ddlusers.SelectedValue == "-1")
        {
            ltext = @" and (dbo.business_trip.RegionCome >= '" + lblgelme1.Text + "' ) AND (dbo.business_trip.GoFromRegion <= '" + lblgetme1.Text + "') ";
      ...
      else if (ddlryn.SelectedValue == "-1") 
        {
            ...
            ltext = @"  and (dbo.Users.UserID = '" + ddlusers.SelectedValue + "')  AND (dbo.business_trip.RegionCome >= '" + lblgelme1.Text + "' ) AND (dbo.business_trip.GoFromRegion <= '" + lblgetme1.Text + "') ";

            
          //  Response.Write("3");
          //  Response.Write("gelme=" + lblgetme1.Text);
        }
        else if (ddlusers.SelectedValue == "-1" && ddlryn.SelectedValue != "-1")
        {
            ltext = @" and dbo.business_trip.RegionID= '" + ddlryn.SelectedValue + "' AND (dbo.business_trip.RegionCome >= '" + lblgelme1.Text + "' ) AND (dbo.business_trip.GoFromRegion <= '" + lblgetme1.Text + "')";
...
WHERE     1=1  " + asort + " " + ltext + " ORDER BY dbo.Users.Name,dbo.Users.SName, dbo.business_trip.RegionCome DESC";
        // Response.Write("5"); 
