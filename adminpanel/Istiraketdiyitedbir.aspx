<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/TesnifatMasterPage.master" AutoEventWireup="true" CodeFile="Istiraketdiyitedbir.aspx.cs" Inherits="adminpanel_Istiraketdiyitedbir" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
       ...
       <div class="altbawliqlar">İştirak etdiyi tədbirə əlavə et</div>
       <div>&nbsp;
           <table style="width: 100%">
               <tr>
...
Təsnifatda yeri:
       ...
       <asp:Panel ID="pnlupdatemeqsed" runat="server"  Visible="False">
           ...
           <div class="altbawliqlar">
               İştirak etdiyi tədbir redaktə et</div>
           <div>
               &nbsp;</div>
        ...
        <asp:Panel ID="pnlyerdeyiw" Visible="false" runat="server">
          ...
          <asp:Panel ID="pnlsil" runat="server"  Visible="False">
             <div class="altbawliqlar">İştirak etdiyi tədbir sil</div>
        <div>&nbsp;</div>
                     <div>&nbsp;<table style="width: 100%">
                       <tr>
