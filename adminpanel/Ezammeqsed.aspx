<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/TesnifatMasterPage.master" AutoEventWireup="true" CodeFile="Ezammeqsed.aspx.cs" Inherits="adminpanel_Ezammeqsed" %>
       ...
       <asp:Panel ID="pnlupdatemeqsed" runat="server"  Visible="False">
           ...
           <table style="width: 100%">
               ...
               <tr>
                   <td class="elaveet" style="width: 171px">&nbsp;</td>
                   <td style="width: 301px">
                       <asp:Button ID="btnmeqsedred" runat="server" OnClick="btnmeqsedred_Click" Text="Mətni dəyish" Width="200px" />
                   </td>
                   <td>
                       <asp:Button ID="btntesnyeri" runat="server" OnClick="btntesnyeri_Click" Text="Yerini dəyish" Width="200px" />
                   </td>
               </tr>
           </table>
