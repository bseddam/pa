<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/TesnifatMasterPage.master" AutoEventWireup="true" CodeFile="Muzakireolmes.aspx.cs" Inherits="adminpanel_Muzakireolmes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div>
       ...
       <div class="altbawliqlar">Müzakirə olunmuş məsələ əlavə et</div>
       <div>&nbsp;
           <table style="width: 100%">
                  <tr>
       ...
       <asp:Panel ID="pnlupdatemeqsed" runat="server"  Visible="False">
           ...
           <table style="width: 100%">
               ...
               <tr>
                   <td class="elaveet" style="width: 171px">&nbsp;</td>
                   <td style="width: 301px">
                       <asp:Button ID="btnmeqsedred" runat="server" OnClick="btnmeqsedred_Click" Text="Mətni dəyiş" Width="230px" />
                   </td>
                   <td>
           ...
           <div class="altbawliqlar">
               Müzakirə olunmuş məsələni redaktə et</div>
           <div>
               &nbsp;</div>
           <div>   <table style="width: 100%">
               ...
               <tr>
                ...
                <tr>
                   <td style="width: 57px">&nbsp;</td>
                   <td style="width: 81px">    <asp:DropDownList ID="ddlmeqsedredakte" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlmeqsedredakte_SelectedIndexChanged">
                       </asp:DropDownList></td>
                   ...
                   <td style="width: 81px">
                       ...
                       <asp:TextBox ID="txtmeqsedredakte" runat="server" TextMode="MultiLine" Width="600px"></asp:TextBox>
                           </td>
          ...
          <asp:Panel ID="pnlsil" runat="server"  Visible="False">
             <div class="altbawliqlar">Müzakirə olunmuş məsələni sil</div>
        <div>&nbsp;</div>
                     <div>&nbsp;<table style="width: 100%">
                       <tr>
