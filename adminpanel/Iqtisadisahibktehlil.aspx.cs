...
public partial class adminpanel_Iqtisadisahibktehlil : System.Web.UI.Page
{
...
where AssortinID=4 and statussablon=1  " + tarixs2 + " " + " " + tarixs1 + "  " + rayon + "  " + " " + userid + sahe + teyinat + icrabarqeyd + " )as cc");
...
from 
(
select case when IcraBaredeMelumat =1 then N'İcrasına başlanmamışdır, Səbəb: ' +Sebeb 
...
sh1,Shkod1,sh2,Shkod2,bis.BusinessTripID
  from business_trip bis  inner join TS10_2 o on bis.BusinessTripID=o.BusinessTripID where  statussablon=1 and  bis.AssortinID=4  " + tarixs2 + " " + " " + tarixs1 + "  " + rayon + "  " +
