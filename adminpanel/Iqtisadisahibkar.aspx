<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/TesnifatMasterPage.master" AutoEventWireup="true" CodeFile="Iqtisadisahibkar.aspx.cs" Inherits="adminpanel_Iqtisadisahibkar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div>
            ...
            <tr>
                ...
                <td style="width: 135px" class="elaveet">
                    &nbsp;</td>
                <td class="elaveet" style="width: 171px">
                    <asp:Button ID="btnistismar" runat="server" Text="Sahə" Width="100px" OnClick="btnistismar_Click" />
                </td>
                <td class="elaveet" style="width: 162px">
                    <asp:Button ID="btnobyekt" runat="server" Text="Təyinat" Width="100px" OnClick="btnobyekt_Click" />
                </td>
                <td>
                    &nbsp;</td>
            </tr>
    ...
    <asp:Panel ID="pnlbirinci" Visible="false" runat="server">
       ...
       <div class="altbawliqlar">Sahə əlavə et</div>
       <div>&nbsp;
           <table style="width: 100%">
                       <tr>
               ...
               <tr>
                ...
                <tr>
                   <td style="width: 53px">&nbsp;</td>
                   <td style="width: 390px">
                       <asp:TextBox ID="txtmeqsedelave" runat="server" TextMode="MultiLine" Width="640px"></asp:TextBox>
                    </td>
       ...
       <asp:Panel ID="pnlupdatemeqsed" runat="server"  Visible="False">
          ...
          <asp:Panel ID="pnlsil" runat="server"  Visible="False">
             <div class="altbawliqlar">Sahə sil</div>
        <div>&nbsp;</div>
                     <div>&nbsp;<table style="width: 100%">
                       <tr>
                   <td style="width: 53px">&nbsp;</td>
           ...
           <asp:Panel ID="pnlikinci" runat="server"  Visible="False">
            ...
            <asp:Panel ID="pnlihbelave" runat="server" Visible="False">
                <div class="altbawliqlar">Təyinat əlavə et:</div>
                <div>&nbsp;</div>

                <table style="width: 767px">
                    <tr>
                        <td style="width: 55px" ></td>
                        <td style="width: 221px" >Sahə:</td>
                       ...
                       <tr>
                        ...
                        <td style="height: 12px; width: 221px;" >&nbsp;
                           </td>
                    </tr>
                       <tr>
                        <td style="width: 55px; height: 23px;" ></td>
                        <td style="height: 23px; width: 221px;" >Təsnifatda yeri: </td>
                    </tr>
                       <tr>
                        <td style="width: 55px; height: 23px;" ></td>
                        <td style="height: 23px; width: 221px;" ><asp:DropDownList ID="ddlmovqe" runat="server" AutoPostBack="True" Enabled="False" OnSelectedIndexChanged="ddlmovqe_SelectedIndexChanged">
                            </asp:DropDownList>
                           </td>
                    </tr>
                                <tr>
                        <td style="width: 55px; height: 7px;" ></td>
                        <td style="height: 7px; width: 221px;" >&nbsp;
                           </td>
                    </tr>
                       <tr>
                        <td style="width: 55px" ></td>
                        <td style="width: 221px" >Yeni təyinat:</td>
                       ...
                       <tr>
                        ...
                        <td style="height: 14px; width: 221px;" >&nbsp;
                           </td>
                    </tr>
                        ...
                        <td style="width: 55px" ></td>
                        <td style="width: 221px" >
                            <asp:Button ID="btnihbelave" runat="server" OnClick="btnihbelave_Click" Text="Əlavə et" Width="100px" Enabled="False" />
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              </td>
                        <td>
                            &nbsp;</td>
     ...
     <asp:Panel ID="pnlyerinideyiw" runat="server" Visible="False">
            ...
            <asp:Panel ID="pnlihbredakte" runat="server" Visible="False">
                <div class="altbawliqlar">Təyinat&nbsp; redaktə et:</div>
            <div>&nbsp;</div>
                    ...
                    <tr>
                       ...
                       <tr>
                        ...
                        <td style="width: 55px" ></td>
                        <td >
                            <asp:TextBox ID="txtihbredakte" runat="server" Width="272px"></asp:TextBox>
                            </td>
                    </tr>
                    <tr>
                        <td style="width: 55px; height: 12px;" ></td>
              ...
              <asp:Panel ID="pnlihbsil" runat="server"  Visible="False">
                  <div class="altbawliqlar">Təyinat sil:</div>
         <div>&nbsp;</div>
