<%@ Page Title="" Language="C#" MasterPageFile="~/adminpanel/adminMasterPage.master" AutoEventWireup="true" CodeFile="IHBtehlil.aspx.cs" Inherits="adminpanel_IHBtehlil" %>
...
normal"><span lang="AZ-LATIN" style="font-size:12.0pt;mso-ansi-language:AZ-LATIN">Şöbə əməkdaşlarının ezamiyyətlər dövründə olduqları İH başçılarının nümayəndəlikləri 
barədə məlumat
</span></b></p>
        <p align="center" class="MsoNormal">
            &nbsp;</p>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:11.25pt" valign="center" width="636">
                    <p align="center" class="MsoNormal">
                        <span lang="AZ-LATIN" style="font-size:11.0pt;mso-ansi-language:AZ-LATIN">İH başçılarının nümayəndəlikləri</span></p>
                </td>
            </tr>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:34.75pt" valign="center" width="154">
                    <p align="center" class="MsoNormal">
                        <span lang="RU" style="font-size: 11.0pt; mso-bidi-font-family: Arial; color: #141823; background: white">Nümayəndəliklərin sayı</span></p>
                </td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:34.75pt" valign="center" width="112">
                    <p align="center" class="MsoNormal">
                        Olduğu n<span lang="RU" style="font-size: 11.0pt; mso-bidi-font-family: Arial; color: #141823; background: white">ümayəndəliklərin sayı</span></p>
                </td>
                <td style="width:84.0pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:18.7pt" valign="center" width="112">
                    <p align="center" class="MsoNormal">
                        <span lang="AZ-LATIN" style="font-size: 12.0pt; mso-ansi-language: AZ-LATIN">
                              <a class="aucun" href='IHBtehlil.aspx?islem=rayon5&tarix1=<%=lblgelme1.Text%>&amp;tarix2=<%=lblgetme1.Text%>&amp;tarix3=<%=lblgelme.Text%>&amp;tarix4=<%=lblgetme.Text%>' style="text-decoration:none;">
...
<%--                <td style="width:109.85pt;border-top:none;border-left:
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:12.55pt" valign="top" width="112">
                    <p align="center" class="MsoNormal">
                        <a class="aucun" href='IHBtehlil.aspx?LivingID=<%#Eval("DelegateID")%>&amp;UserID=<%#Eval("UserID")%>&amp;islem=rayon5&amp;RegionID=<%#Eval("RegionID")%>&amp;tarix1=<%#lblgelme1.Text%>&amp;tarix2=<%#lblgetme1.Text%>&amp;tarix3=<%#lblgelme.Text%>&amp;tarix4=<%#lblgetme.Text%>' style="text-decoration:none;"><%#Eval("meqseds") %></a>
                    </p>
                </td>
            </tr>
                        </ItemTemplate>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:12.1pt" valign="top" width="112">
                               <p align="center" class="MsoNormal">
                                  <a href="ezamiyye.aspx?BusinessTripID=<%#Eval("BusinessTripID") %>&islem1=IHBtehlil&RegionID=<%#Eval("RegionID") %>&controlBusinesTrip=1&UserID=<%#Eval("UserID") %>">Baxış</a></p>
                           </td>
                               </asp:Panel>
                       </tr>
                   </ItemTemplate>
