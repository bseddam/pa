<%@ Page Title="" Language="C#" MasterPageFile="~/kurator/KuratorhisseMasterPage.master" AutoEventWireup="true" CodeFile="HesabatKurator.aspx.cs" Inherits="kurator_HesabatKurator" %>
    ...
    <div>
        ...
        <asp:Panel ID="pnlhesabatabax" Visible="false" runat="server">
            ...
            <div style="float: left; width: 346px; padding-top: 10px; padding-bottom: 10px; height: 187px;">
                ...
                <br />
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Hesabata bax" Width="120px" Style="height: 26px" />
                &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div style="float: left; width: 284px;">
                ...
                <asp:ImageButton ID="imgbsilgelme" runat="server" Height="14px" OnClick="imgbsilgelme_Click" src="../adminpanel/images/iconlar/sil.png" Visible="False" Width="14px" />
            ...
            <div style="float: left; width: 377px;">
                ...
                <asp:ImageButton ID="imgbsilgetme0" runat="server" Height="14px" OnClick="imgbsilgetme0_Click" src="../adminpanel/images/iconlar/sil.png" Visible="False" Width="14px" />
            ...
            <asp:Panel ID="Panel1" runat="server">
                ...
                <div>
                    <table style="border-collapse: collapse; width: 100%;">
                        <tr>
                            <td style="border-style: solid solid none solid; border-width: 1px 1px 0px 1px; border-color: black; text-align: center; width: 15%; white-space: normal;"><strong>Kuratorun adı</strong></td>
                            <td style="border-style: solid solid none solid; border-width: 1px 1px 0px 1px; border-color: black; text-align: center; width: 20%; white-space: normal;"><strong>Rayonun,<br />
                                şəhərin adı</strong></td>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <asp:Panel ID="Panel2" runat="server">
                                        <td style="border: 1px solid black; text-align: center; width: 6%; white-space: normal;"><a href="../adminpanel/ezamiyye.aspx?BusinessTripID=<%#Eval("BusinessTripID") %>&islem1=adminislem<%#lbldey.Text%>&RegionID=<%#Eval("RegionID") %>&controlBusinesTrip=1&UserID=<%#Eval("UserID") %>">Baxış</a></td>
                                        <td style="border: 1px solid black; text-align: center; width: 11%; white-space: normal;">
                                            <asp:Panel ID="pnlyukle" Visible='<%#Convert.ToBoolean(yuklegorun(Eval("FileName").ToString()))%>' runat="server">
                                                <a class="aucun" href='HesabatKurator.aspx?RayonID=<%#Eval("RegionID") %>&UserID=<%#Eval("UserID") %>&BusinessTripID=<%#Eval("BusinessTripID") %>&islem=fayl&filename=<%#Eval("FileName") %>'>Yüklə</a>
                                            </asp:Panel>
                                        </td>
                                       <%-- <td style="border: 1px solid black; text-align: center; width: 10%; white-space: normal;">
                                            <asp:Panel ID="Panel9" Visible='<%#Convert.ToBoolean(yuklegorun(Eval("FileName").ToString()))%>' runat="server">
                                                <a class="aucun" href='HesabatKurator.aspx?RayonID=<%#Eval("RegionID") %>&UserID=<%#Eval("UserID") %>&BusinessTripID=<%#Eval("BusinessTripID") %>&islem1=adminislem<%#lbldey.Text%>&islem=faylsil&filename=<%#Eval("FileName") %>'>Sil</a>
                                            </asp:Panel>
                                        </td>--%>
                                    </asp:Panel>
                    ...
                    <table style="border-collapse: collapse; width: 100%;">
                        <tr>
                            ...
                            <asp:Panel ID="Panel5" runat="server">
                                <td style="border-style: solid solid none solid; border-width: 1px 1px 0px 1px; border-color: black; text-align: center; width: 6%; white-space: normal;"><strong>Baxış</strong></td>
                                <td style="border-style: solid solid none solid; border-width: 1px 1px 0px 1px; border-color: black; text-align: center; width: 11%; white-space: normal;"><strong>Təklif</strong></td>
                                <td style="border-style: solid solid none solid; border-width: 1px 1px 0px 1px; border-color: black; text-align: center; width: 10%; white-space: normal;"><strong>Sil</strong></td>
                                 <%--     <td style="border-style: solid solid none solid; border-width: 1px 1px 0px 1px; border-color: black; text-align: center; width: 10%; white-space: normal;"><strong>Təklifi sil</strong></td>
                           --%> </asp:Panel>
                        </tr>
                    </table>
                        ...
                        <asp:Repeater ID="rpyenideniwle" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td style="border: 1px solid black; text-align: center; width: 20%; white-space: normal;"><%#Class2.sozukes(Eval("GoFromRegion").ToString()) %></td>
                                    <asp:Panel ID="Panel2" runat="server">
<td style="border: 1px solid black; text-align: center; width: 6%; white-space: normal;"><a href="../adminpanel/ezamiyye.aspx?BusinessTripID=<%#Eval("BusinessTripID") %>&islem1=adminislem3&RegionID=<%#Eval("RegionID") %>&controlBusinesTrip=1&UserID=<%#Eval("UserID") %>">Baxış</a></td>
                                        <td style="border: 1px solid black; text-align: center; width: 11%; white-space: normal;">
                                            <asp:Panel ID="pnlyukle" Visible='<%#Convert.ToBoolean(yuklegorun(Eval("FileName").ToString()))%>' runat="server">
                                                <a class="aucun" href='HesabatKurator.aspx?RayonID=<%#Eval("RegionID") %>&UserID=<%#Eval("UserID") %>&BusinessTripID=<%#Eval("BusinessTripID") %>&islem=fayl&filename=<%#Eval("FileName") %>'>Yüklə</a>
                                            </asp:Panel>
                                        ...
                                        <td style="border: 1px solid black; text-align: center; width: 10%; white-space: normal;">
                                               <a class="aucun" href='HesabatKurator.aspx?BusinessTripID=<%#Eval("BusinessTripID") %>&islem=rayonsil'>Sil</a>
<%--<a class="aucun" href='HesabatKurator.aspx?RayonID=<%#Eval("RegionID") %>&islem=rayonsil&BusinessTripID=<%#Eval("BusinessTripID") %>&rownumber=<%#Container.ItemIndex %>'>Sil</a>--%>
                                        
                                        </td>
                                        <%--<td style="border: 1px solid black; text-align: center; width: 10%; white-space: normal;">
                                            <asp:Panel ID="Panel9" Visible='<%#Convert.ToBoolean(yuklegorun(Eval("FileName").ToString()))%>' runat="server">
                                                <a class="aucun" href='HesabatKurator.aspx?RayonID=<%#Eval("RegionID") %>&UserID=<%#Eval("UserID") %>&BusinessTripID=<%#Eval("BusinessTripID") %>&islem=faylsil&filename=<%#Eval("FileName") %>'>Sil</a>
                                            </asp:Panel>
                                        </td>--%>
                                    </asp:Panel>
